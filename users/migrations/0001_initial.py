    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('other_name', models.CharField(blank=True, max_length=255, null=True, verbose_name='other_name')),
                ('email', models.CharField(blank=True, max_length=255, null=True, verbose_name='email')),
                ('phone', models.CharField(blank=True, max_length=255, null=True)),
                ('birthday', models.DateField(blank=True, null=True, verbose_name='phone')),
